...
|     |     |     |
| --- | --- | --- |
| [DanBradbury/copilot-chat.vim](https://github.com/DanBradbury/copilot-chat.vim) | Copilot Chat for Vim | ⭐132 |
...
| [girishji/vimsuggest](https://github.com/girishji/vimsuggest) | Auto-completion for Vim's command-line. | ⭐51 |
...
|     |     |     |
| --- | --- | --- |
| [vim-fuzzbox/fuzzbox.vim](https://github.com/vim-fuzzbox/fuzzbox.vim) | Modern fuzzy finder for Vim with minimal dependencies | ⭐156 |
...
|     |     |     |
| --- | --- | --- |
| [yegappan/battleship](https://github.com/yegappan/battleship) | Battleship game for Vim | ⭐11 |
| [yegappan/game2048](https://github.com/yegappan/game2048) | Game 2048 implemented using Vim9script | ⭐1 |
...
| [yegappan/design-patterns](https://github.com/yegappan/design-patterns) | Design patterns in Vim9script | ⭐7 |
...
| [yegappan/lsp](https://github.com/yegappan/lsp/tree/main) | Language Server Protocol (LSP) plugin for Vim9 | ⭐723 |
...
| [lifepillar/vim-colortemplate](https://codeberg.org/lifepillar/vim-colortemplate/src/branch/v3) |  The Toolkit for Vim Color Scheme Designers! | ⭐2 |
...
| [greeschenko/vimsidian](https://github.com/greeschenko/vimsidian) | Minimalistic Obsidian-like note system inside Vim (Vim9script). | ⭐1 |

## Miscellaneous

|     |     |     |
| --- | --- | --- |
| [nda-cunh/PropColor](https://github.com/nda-cunh/PropColor) | vim9script plugin to draw colors in your editor | ⭐3 |
...
| [wolandark/vim-ez-emoji](https://github.com/wolandark/vim-ez-emoji) | An easy emoji plugin for vim written in vim9script | ⭐11 |
...
| [monkoose/vim9-stargate](https://github.com/monkoose/vim9-stargate) | modern alternative to easymotion written in vim9 | ⭐122 |
...
| [kennypete/vim-tene](https://github.com/kennypete/vim-tene) | Vim 9 - teRNARY STATUSLIne | ⭐16 |
...
| [vim-airline/vim-airline](https://github.com/vim-airline/vim-airline) | lean & mean status/tabline for vim that's light as air | ⭐17943 |
...
| [bennyyip/dot-vim](https://github.com/bennyyip/dot-vim) | *No description provided.* | ⭐8 |
