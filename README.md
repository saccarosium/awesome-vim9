...
| [ubaldot/vim-op-surround](https://github.com/ubaldot/vim-op-surround) | Vim9 surround!  | ⭐1 |
...
|     |     |     |
| --- | --- | --- |
| [Donaldttt/fuzzyy](https://github.com/Donaldttt/fuzzyy) | A  vim9 fuzzy finder plugin with minimal dependency and modern UI | ⭐113 |
...
| [yegappan/lsp](https://github.com/yegappan/lsp/tree/main) | Language Server Protocol (LSP) plugin for Vim9 | ⭐587 |
...
|     |     |     |
| --- | --- | --- |
| [ShayHill/vim9-limelight](https://github.com/ShayHill/vim9-limelight) | Shade unfocused windows. Give a bright statusline color for active windows *when splits are open*. | ⭐0 |
